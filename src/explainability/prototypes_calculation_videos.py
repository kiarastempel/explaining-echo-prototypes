...
def get_kmedoids_prototype_videos(num_ef_clusters, video_clusters_directory,
    ...
    for i in range(num_ef_clusters):
        ...
        video_cluster_sizes.append([])
        video_cluster_means.append([])
        video_cluster_stds.append([])
        for j in range(num_video_clusters):
            ...
            video_cluster_sizes[i].append(len(videos_in_cluster))
            video_cluster_means[i].append(np.mean(efs_cluster))
            video_cluster_stds[i].append(np.std(efs_cluster))
